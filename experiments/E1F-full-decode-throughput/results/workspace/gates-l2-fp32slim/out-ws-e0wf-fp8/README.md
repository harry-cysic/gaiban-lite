...
Implementation: `873c5dd370bea55d8310dc1702e7da590f57c75975821a085be5350995371139`

- `prefill96_decode34_ring_cross`: PASS; worst rms_rel `decode_pos124.output_lora=0.0167222` (limit `0.09`)
- `prefill128_decode4`: PASS; worst rms_rel `prefill.output_lora=0.0157872` (limit `0.09`)
- `prefill200_decode4`: PASS; worst rms_rel `prefill.output_lora=0.016107` (limit `0.09`)
